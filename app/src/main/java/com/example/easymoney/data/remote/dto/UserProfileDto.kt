...
data class IdentityStatusDto(
    ...
    val isIdentityDocumentVerified: Boolean? = null,
...
private fun IdentityStatusDto.toDomain() = IdentityVerificationStatus(
    ...
    isDocumentUploadVerified = isDocumentUploadVerified ?: isIdentityDocumentVerified ?: false,
    isBiometricEnabled = isBiometricEnabled ?: false
)

fun ProfileCompletionDto.toDomain() = ProfileCompletion(
